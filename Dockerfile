...
### version 1.2.9
#RUN wget -O terraform_binary.zip https://releases.hashicorp.com/terraform/1.2.9/terraform_1.2.9_linux_amd64.zip 
## version 1.3.1
RUN wget -O terraform_binary.zip https://releases.hashicorp.com/terraform/1.3.1/terraform_1.3.1_linux_amd64.zip 
